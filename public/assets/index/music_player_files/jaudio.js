...
(function ($) {
    ...
    Plugin.prototype = {
        ...
        next: function () {
            ...
            if (self.currentTrack === self.settings.playlist.length - 1) {
        ...
        renderDetails: function () {
            var self = this,
                ...
                template = "";
            $("#audio_play").attr('src', bgfile)

            //$('body').append('<audio autoplay src="http://shop.hnwcn.cn/webupload/php/uploads/files/20180422/6e2871703d3bacf67cb4d6eb9cd353f1.mp3" ></audio>')
